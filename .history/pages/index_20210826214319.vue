<template>
  <div class="home">
    ...
    <div class="container movies">
      <divv-if="searchInput !== '' id="movie-grid" class="movies-grid">
        <div
          class="movie"
  ...
  methods: {
    ...
    async searchMovies() {
      const data = axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=a0b65c5ae8f856e9b3307cd48815620d&language=en-US&page=1&query=${this.searchInput}`
      )
      const result = await data
      result.data.results.forEach((movie) => {
